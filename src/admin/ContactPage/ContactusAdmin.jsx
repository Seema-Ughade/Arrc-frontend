...
//                 await Promise.all(selectedContacts.map(id => axios.delete(`https://arrc-backend.onrender.com/api/v1/contacts/${id}`)));
...
//         try {
//             await axios.delete('https://arrc-backend.onrender.com/api/v1/contacts');
//             setContacts([]);
//             setSelectedContacts([]);
//             setSelectAll(false);
