  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/digital-business-card" element={<><Navbar /><DigitalBusinessCard /><Chatbot/><CatelogDownload/><Footer /></>} />
        <Route path="/digital-brochure" element={<><Navbar /><DigitalBroucher /><Chatbot/><CatelogDownload/><Footer /></>} />
