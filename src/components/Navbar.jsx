...
//     const handleSolutionsHover = (isHovering) => {
...
//         } else {
//             timeoutRef.current = setTimeout(() => setShowSolutions(false), 300);
//         }
//     };

//     const handleDigitalSolutionsHover = (isHovering) => {
//         clearTimeout(timeoutRef.current);
//         if (isHovering) {
//             setShowDigitalSolutions(true);
//             setShowSolutions(false);

//         } else {
//             timeoutRef.current = setTimeout(() => setShowDigitalSolutions(false), 300);
//         }
//     };
...
//                                         whileHover={{ scale: 1.05 }}
//                                         onMouseEnter={() => handleDigitalSolutionsHover(true)}
//                                         onMouseLeave={() => handleDigitalSolutionsHover(false)}
//                                     >
//                                         <button
...
//                                         whileHover={{ scale: 1.05 }}
//                                     >
//                                         <Link to="/home" className="hover:text-custom-purple  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
//                                             Home
//                                         </Link>
//                                     </motion.li>
//                                     <motion.li
//                                         whileHover={{ scale: 1.05 }}
//                                     >
//                                         <Link to="/about" className="hover:text-custom-purple  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
//                                             About Us
//                                         </Link>
//                                     </motion.li>
...
//                                         <button
//                                             onClick={handleSolutionsClick}
//                                             className="hover:text-custom-purple px-4 py-2 rounded-md block w-full text-center lg:text-left"
//                                         >
//                                             Software Solutions
//                                             <i className={`fa ${showSolutions ? 'fa-times' : 'fa-plus'} ml-2 text-xxs`}></i>
...
//                                                 >
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/website-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Website Development</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/app-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>App Development</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/software-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Software Development</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/ecommerce-solution" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>E-Commerce Solutions</Link>
//                                                     </motion.li>
//                                                 </motion.ul>
//                                             </motion.ul>
//                                         )}
...
//                                                 >
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/seo-solution" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>SEO/SEM Solutions</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/digital-marketing" className="block px-4  py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Marketing</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/digital-business-card" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Business Card</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/digital-brochure" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Brochure</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/bulk-sms-solutions" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>Bulk SMS Solutions</Link>
//                                                     </motion.li>
//                                                     <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
//                                                         <Link to="/ivr-solutions" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-custom-purple" onClick={() => { handleLinkClick(); scrollToTop(); }}>IVR Solutions</Link>
//                                                     </motion.li>
//                                                 </motion.ul>
//                                             </motion.ul>
//                                         )}
...
//                                         whileHover={{ scale: 1.05 }}
//                                     >
//                                         <Link to="/cyber-security" className="hover:text-custom-purple  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
//                                             Cyber Security
//                                         </Link>
//                                     </motion.li>
//                                     <motion.li
//                                         whileHover={{ scale: 1.05 }}
//                                     >
//                                         <Link to="/contact-us" className="hover:text-custom-purple  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
//                                             Contact Us
//                                         </Link>
//                                     </motion.li>
    ...
    return (
        <>
            ...
            >
                <div className="bg-gray-950 box-border  text-white">
                    {/* <div className="container  sm:justify-center lg:justify-between md:justify-between flex items-center box-border   py-0 px-2 relative"> */}
                        {/* <div className="container mx-auto flex lg:flex-col sm:flex-row sm:justify-center lg:justify-between md:justify-between items-center  px-4 sm:px-6 lg:px-8 relative box-border"> */}
                        {/* <div className="container mx-auto flex  sm:flex-row sm:justify-center lg:justify-between md:justify-between items-center  px-4 sm:px-6 lg:px-8 relative box-border">coeewct */}
                        <div className="container flex sm:flex-row sm:justify-center lg:justify-between md:justify-between items-center relative box-border sm:max-w-[800px] md:max-w-[1000px] lg:max-w-[1100px] xl:max-w-[1400px] xl-max:max-w-[1600px] 2xl:max-w-[1800px]">


                        {/* Logo */}
                        <div className="demo-logo-vertical flex justify-start items-center bg-gray-950">
                            <Link to="/" onClick={() => { handleLinkClick(); scrollToTop(); }}>
                                <img src={mainlogo} alt="Logo" className="h-24 object-contain" />
                            </Link>         <span
                                className=" text-white text-2xl w-25  font-bold block  "
                            ...
                            <nav className={`lg:flex lg:items-center lg:space-x-6 ${isOpen ? 'block' : 'hidden'} lg:block`}>
                                ...
                                <ul className="flex flex-col    lg:flex-row lg:space-x-1">
                                    ...
                                    <motion.li
                                        whileHover={{ scale: 1.05 }}
                                    >
                                        <Link to="/home" className="  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
                                            Home
                                        </Link>
                                    </motion.li>
                                    <motion.li
                                        whileHover={{ scale: 1.05 }}
                                    >
                                        <Link to="/about" className=" px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
                                            About Us
                                        </Link>
                                    </motion.li>
...
<motion.li 
                                ...
                                >
                                        <button
                                            // onClick={handleSolutionsClick}
                                            className=" px-4 py-2 rounded-md block w-full text-center lg:text-left"
                                        >
                                            Software Solutions
                                            <i className={`fa ${showSolutions ? 'fa-times' : 'fa-plus'} ml-2 text-xxs`}></i>
                                        ...
                                        {showSolutions && (
                                            ...
                                            >
                                                ...
                                                >
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/website-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Website Development</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/app-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>App Development</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/software-development" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Software Development</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/ecommerce-solution" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>E-Commerce Solutions</Link>
                                                    </motion.li>
                                                </motion.ul>
                                            </motion.ul>
                                        )}
                                    ...
                                    >
                                        ...
                                        {showDigitalSolutions && (
                                            ...
                                            >
                                                ...
                                                >
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/seo-solution" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>SEO/SEM Solutions</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/digital-marketing" className="block px-4  py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Marketing</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/digital-business-card" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Business Card</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/digital-brochure" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Digital Brochure</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/bulk-sms-solutions" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>Bulk SMS Solutions</Link>
                                                    </motion.li>
                                                    <motion.li variants={{ hidden: { opacity: 0, y: -20 }, visible: { opacity: 1, y: 0 } }}>
                                                        <Link to="/ivr-solutions" className="block px-4 py-2 bg-gray-800 hover:bg-gray-700 hover:text-customCyan" onClick={() => { handleLinkClick(); scrollToTop(); }}>IVR Solutions</Link>
                                                    </motion.li>
                                                </motion.ul>
                                            </motion.ul>
                                        )}
                                    ...
                                    <motion.li
                                        whileHover={{ scale: 1.05 }}
                                    >
                                        <Link to="/cyber-security" className="  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
                                            Cyber Security
                                        </Link>
                                    </motion.li>
                                    <motion.li
                                        whileHover={{ scale: 1.05 }}
                                    >
                                        <Link to="/contact-us" className="  px-4 py-2 rounded-md block text-center lg:text-left" onClick={() => { handleLinkClick(); scrollToTop(); }}>
                                            Contact Us
                                        </Link>
                                    </motion.li>
