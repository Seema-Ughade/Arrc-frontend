    ...
    <div className="container mx-auto p-6  text-white sm:max-w-[800px] md:max-w-[1000px] lg:max-w-[1100px] xl:max-w-[1400px] xl-max:max-w-[1600px] 2xl:max-w-[1800px]">
      ...
      >
        <div className="w-full lg:w-3/4 text-center">
          ...
          <p className="text-lg md:text-xl mb-4 text-white leading-relaxed font-normal antialiased">
            Arrc Technology has a team of highly skilled software developers who are committed to giving the best output and best advice with an outstanding design, short, iterative development cycles, combined with your ongoing feedback and usability with a high-quality product.
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="lg:w-1/2 w-full lg:pl-6 lg:text-left text-left">
          ...
          <p className="text-lg md:text-xl mb-4 text-white leading-relaxed font-normal antialiased">
            Arrc Technology is the famous leading & award-winning website design & development company. Being a top digital marketing & SEO company in Pune, we provide solutions for web design & web development services. Our customer-centric approach makes us a unique solutions provider for website designing & development. Our expert development team specializes in building static, dynamic, functional, responsive, SEO-friendly, and user-friendly websites.
          </p>
          <p className="text-lg md:text-xl mb-4 text-white leading-relaxed font-normal antialiased">
      ...
      {/* Third Section: What We Offer and Why Arrc Technology */}
      <motion.div
