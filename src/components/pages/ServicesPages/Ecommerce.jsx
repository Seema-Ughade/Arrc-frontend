      ...
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center pl-0 md:pl-8 mt-6 md:mt-0">
          ...
          <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-4">
            Bizzfly is an eCommerce web development company in Pune which offers e-commerce development to various types of retailers, sellers, and manufacturers. E-commerce development depends on the type of business model you have like
          </p>
