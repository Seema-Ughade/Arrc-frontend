...
//             <h2 className="text-2xl font-bold mb-4 text-purple-500">Our Services</h2>
//             <ul className="grid grid-cols-2 gap-4">
//               <li><Link to="/website-development" className="text-blue-400 hover:underline" onClick={scrollToTop}>Website Development</Link></li>
//               <li><Link to="/app-development" className="text-blue-400 hover:underline" onClick={scrollToTop}>App Development</Link></li>
//               <li><Link to="/software-development" className="text-blue-400 hover:underline" onClick={scrollToTop}>Software Development</Link></li>
//               <li><Link to="/ecommerce-solution" className="text-blue-400 hover:underline" onClick={scrollToTop}>E-Commerce Solutions</Link></li>
//               <li><Link to="/seo-solution" className="text-blue-400 hover:underline" onClick={scrollToTop}>SEO/SEM Solutions</Link></li>
//               <li><Link to="/digital-marketing" className="text-blue-400 hover:underline" onClick={scrollToTop}>Digital Marketing</Link></li>
//               <li><Link to="/digital-business-card" className="text-blue-400 hover:underline" onClick={scrollToTop}>Digital Business Card</Link></li>
//               <li><Link to="/digital-brochure" className="text-blue-400 hover:underline" onClick={scrollToTop}>Digital Brochure</Link></li>
//               <li><Link to="/bulk-sms-solutions" className="text-blue-400 hover:underline" onClick={scrollToTop}>Bulk SMS Solutions</Link></li>
//               <li><Link to="/ivr-solutions" className="text-blue-400 hover:underline" onClick={scrollToTop}>IVR Solutions</Link></li>
//               <li><Link to="/cyber-security" className="text-blue-400 hover:underline" onClick={scrollToTop}>Cyber Security</Link></li>
...
//             </div>
//             <div className="flex flex-wrap space-x-4 text-sm mb-4">
//               <Link to="/privacy-policy" className="text-blue-400 hover:underline" onClick={scrollToTop}>Privacy Policy</Link>
//               <Link to="/terms-of-service" className="text-blue-400 hover:underline" onClick={scrollToTop}>Terms of Service</Link>
//               <Link to="/faq" className="text-blue-400 hover:underline" onClick={scrollToTop}>FAQ</Link>
//             </div>
//             <div className="text-sm">
//               <a href="#top" className="text-blue-400 hover:underline">Back to Top</a>
//             </div>
      ...
      <div className="container  px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <motion.section 
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl font-bold mb-4 text-custom-purple">Our Services</h2>
            <ul className="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {/* Contact Information & Footer Text Section */}
          <motion.section 
            className="footer-section lg:ml-10 flex flex-col "
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            <div className="flex items-center mb-4 space-x-4">
              <a href="https://www.facebook.com/Thearrctechnologyofficial" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-2xl hover:text-blue-700 transition-colors duration-300">
                <FaFacebook />
              </a>
              <a href="https://www.linkedin.com/company/arrctech/" target="_blank" rel="noopener noreferrer" className="text-blue-700 text-2xl hover:text-blue-800 transition-colors duration-300">
                <FaLinkedin />
              </a>
              <a href="https://www.instagram.com/arrctech/" target="_blank" rel="noopener noreferrer" className="text-pink-600 text-2xl hover:text-pink-700 transition-colors duration-300">
                <FaInstagram />
              </a>
              <a href="https://wa.link/zkcnv2" target="_blank" rel="noopener noreferrer" className="text-blue-400 text-2xl hover:text-blue-500 transition-colors duration-300">
                <FaWhatsapp />
              </a>
            </div>
            <div className="text-base mb-4">
